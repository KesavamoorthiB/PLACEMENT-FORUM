  ...
  <div class="wrapper">
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            <h3 class="text-center margin-bottom-20">Dear Company's Drop Your Details Here!!!</h3>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 Bharathiar University <a href="learningfromscratch.online">For 💖 DCA Students</a>.</strong> All rights
        reserved.
      </div>
    </footer>
